...
public class CatalogoAlimento implements Catalogo{
	...
	public CatalogoAlimento(){
		...
		Producto p1 = new Alimento("00","Manzana dorada", "Si la comes, tendras mucha suerte", 15, 2,-6); 
		agregarProducto((Object) p1);
		Producto p2 = new Alimento("01","Hamburguesa", "Para salir de la rutina ¿no?", 23, -15,3);
		agregarProducto((Object) p2);
		Producto p3 = new Alimento("02","Salmon", "Fino señores", 18, 8,-8);
		agregarProducto((Object) p3);
		Producto p4 = new Alimento("03","Galletas premium", "Unas simples galletas no te van a matar", 7, -18,-18);
		...
		Producto p8 = new Alimento("07","Pizza", "Mmm.. pizza", 14, -20,14);
		...
		Producto p14 = new Alimento("13","Oro...", "parece, plata no es; el que no la adivine bien tonto es", 10, 10,-17);
