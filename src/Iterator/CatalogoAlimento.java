...
public class CatalogoAlimento implements Catalogo{
	...
	public CatalogoAlimento(){
		...
		Producto p1 = new Alimento("00","Manzana dorada", "Si la comes, tendras mucha suerte", 7, 2,-6); //Precio, puntosHambre, puntosFelicidad
		...
		Producto p3 = new Alimento("02","Salmon", "Fino señores", 15, 8,8); //Precio, puntosHambre, puntosFelicidad
		...
		Producto p5 = new Alimento("04","Cebollas", "Pa' llorar a gusto", 10, -19,13); //Precio, puntosHambre, puntosFelicidad
		agregarProducto((Object) p5);
		Producto p6 = new Alimento("05","Papas fritas", "¿A quien no le gustan?", 11.0, 5,3);
		agregarProducto((Object) p6);
		Producto p7 = new Alimento("06","Liquido misterioso", "Claramente es una trampa", 20, 15,3); //Precio, puntosHambre, puntosFelicidad
		...
		Producto p11 = new Alimento("10","Tacos", "¿A quien no le gustan? x2", 15, -12,8); //Precio, puntosHambre, puntosFelicidad
		...
		Producto p13 = new Alimento("12","Agua...", "pasa por mi casa, cate de mi corazon el que no me la adivine es un burro cabezon", 5, -12,-12); //Precio, puntosHambre, puntosFelicidad
